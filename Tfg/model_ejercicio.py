# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 17:19:36 2024
...
class BoneTurnoverModel(object):
    ...
    def _derivative(self, t, x):
        ...
        D = [    
            ...
            # bone density con nivel ejercicio
            (bp - bm)*(1-p['nivel_ejercicio']),
            # bone mineral fraction
...
class OsteoporosisModel(BoneTurnoverModel):
    def __init__(
        ...
        all_params.update__params('nivel_ejercicio',self.nivel_ejercicio())
        ...
        #self.update__params('nivel_ejercicio',self.nivel_ejercicio()) 
    ...
    def variable_ejercicio(self):
        m = input('Dime cuanto ejercicio ha hecho: 0-nada , 1-medio , 2-mucho   -->')
        n = float(m)
        #if n!=0 or n!=1 or n!=2 :
        #    raise ValueError('No me has dado el número pedido')
            
        return n
    
    def nivel_ejercicio(self):
        ejercicio = self.variable_ejercicio()
        tasa_ejercicio =0
        if ejercicio==0:
            tasa_ejercicio =0.1
        elif ejercicio==1:
