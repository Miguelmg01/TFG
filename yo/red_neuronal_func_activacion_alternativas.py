# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 10:42:01 2024
...
#funcion activacion relu,selu malas error grande
#funcion activacion swish tampoco es buena
model = Sequential()
model.add(Dense(64, input_dim=X.shape[1], activation=tf.keras.activations.swish, kernel_regularizer=l2(0.01)))
model.add(Dropout(0.3))
model.add(Dense(32, activation=tf.keras.activations.swish, kernel_regularizer=l2(0.01)))
model.add(Dropout(0.3))
model.add(Dense(16, activation=tf.keras.activations.swish, kernel_regularizer=l2(0.01)))
