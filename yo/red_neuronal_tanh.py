# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 10:36:29 2024
...
#funcion activacion tanh,funciona mejor la sigmoid
model = Sequential()
model.add(Dense(64, input_dim=X.shape[1], activation=tf.keras.activations.tanh, kernel_regularizer=l2(0.01)))
model.add(Dropout(0.3))
model.add(Dense(32, activation=tf.keras.activations.tanh, kernel_regularizer=l2(0.01)))
model.add(Dropout(0.3))
model.add(Dense(16, activation=tf.keras.activations.tanh, kernel_regularizer=l2(0.01)))
